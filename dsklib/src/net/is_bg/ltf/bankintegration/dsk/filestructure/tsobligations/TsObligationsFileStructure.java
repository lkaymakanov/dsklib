 ...
 *
 */
public class TsObligationsFileStructure implements IFileStructure{

	TsObligationsHeaderLine header = new TsObligationsHeaderLine();
	TsObligationsDetailLine detail = new TsObligationsDetailLine();
